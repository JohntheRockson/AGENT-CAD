...
| 4) fillet under-head / named R (Δvol-only = FAIL; silent no-op = FAIL) | PASS | fillet R + hex look: named/hex-corner R≈0.8 mm (median err 0.121 mm, n=2820); ΔAF=0.000 Δmin_r=0.924 Δmax_r=0.000 Δvolume=4.123 (Δvol alone is not sufficient) |
...
- Engine::execute (M8 + under-head/named fillet r=0.8) ok in 8.39s  volume=2515.788 bbox=[-7.505553722381592, -6.5, 0.0, 7.505553722381592, 6.5, 40.095184326171875] is_solid=true
