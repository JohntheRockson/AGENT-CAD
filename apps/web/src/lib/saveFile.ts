...
export const EXPORT_KINDS: ExportKind[] = [
  { id: 'step', ext: 'step', label: 'STEP', mime: 'application/step',         hint: 'CAD interchange — SolidWorks, Fusion, Onshape' },
...
export async function pickSaveTarget(kind: ExportKind): Promise<SaveTarget> {
